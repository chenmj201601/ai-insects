...
def parse_args():
    ...
    parser.add_argument(
        '--image_name',
        type=str,
        default='./insects/test/images/1898.jpeg',
    ...
    parser.add_argument(
        ...
        type=str,
        default='output_pic',
        help='the name of output picture')
    ...
    with fluid.dygraph.guard():
        ...
        for i, data in enumerate(test_loader()):
            ...
            for j in range(len(result)):
                result_j = result[j]
                total_results.append(result_j)

        result = total_results[0]
        draw_results(result, IMAGE_NAME, output_name=OUTPUT_NAME, draw_thresh=0.2)
